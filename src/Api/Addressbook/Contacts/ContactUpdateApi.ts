...
import { IContactUpdateArgs } from "../interfaces";

export class ContactUpdateApi {
    private url: string;
    ...
    public async Run(args?: IContactUpdateArgs): Promise<ContactApiResponseDTO | ErrorResponseDTO> {
        if (args) {
