...
import { IOptOutDeleteArgs } from "./interfaces";

export class OptOutDeleteApi {
    ...
    public async Run(args?: IOptOutDeleteArgs): Promise<OptOutApiResponseDTO | ErrorResponseDTO> {
        if (args) {
